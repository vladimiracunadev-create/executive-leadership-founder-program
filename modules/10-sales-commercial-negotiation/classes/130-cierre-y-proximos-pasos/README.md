# Clase 130 — Cierre y próximos pasos
...
Guarda en `portfolio/130-cierre-y-proximos-pasos/`:

- `leadership-decision-brief.md` con el problema específico de **cierre y próximos pasos**, evidencia, alternativas, decisión y gobernanza;
- `reading-note.md` contrastando las fuentes de **cierre y próximos pasos** con edición/páginas consultadas;
- `decision-journal.md` registrando los supuestos de **commitment**, confianza, responsable y revisión;
- `red-team.md` con la objeción más fuerte al caso **El vendedor marca deal como 'commit' porque el sponsor dijo que quiere avanzar. Legal, seguridad y procurement aún no revisan y el presupuesto vence en 30 días.** y el dato que podría invalidar la recomendación.

## 📗 Fuentes y verificación

- Neil Rackham — *SPIN Selling*. **Uso en esta clase:** venta consultiva basada en preguntas de situación, problema, implicación y necesidad. Lectura selectiva: índice/capítulos pertinentes a **cierre y próximos pasos**; registra edición y páginas consultadas.
- Matthew Dixon & Brent Adamson — *The Challenger Sale*. **Uso en esta clase:** venta compleja, insight comercial, enseñanza y control constructivo del proceso. Lectura selectiva: índice/capítulos pertinentes a **cierre y próximos pasos**; registra edición y páginas consultadas.
- Deepak Malhotra & Max H. Bazerman — *Negotiation Genius*. **Uso en esta clase:** perspectiva de Negociación aplicada al problema de la clase. Lectura selectiva: índice/capítulos pertinentes a **cierre y próximos pasos**; registra edición y páginas consultadas.
- Mark Roberge — *The Sales Acceleration Formula*. **Uso en esta clase:** perspectiva de Ventas aplicada al problema de la clase. Lectura selectiva: índice/capítulos pertinentes a **cierre y próximos pasos**; registra edición y páginas consultadas.
- Thomas T. Nagle, John E. Hogan & Joseph Zale — *The Strategy and Tactics of Pricing*. **Uso en esta clase:** arquitectura de precios basada en valor, segmentación y respuesta competitiva. Lectura selectiva: índice/capítulos pertinentes a **cierre y próximos pasos**; registra edición y páginas consultadas.
- Roger Fisher, William Ury & Bruce Patton — *Getting to Yes*. **Uso en esta clase:** negociación basada en intereses, opciones y criterios objetivos. Lectura selectiva: índice/capítulos pertinentes a **cierre y próximos pasos**; registra edición y páginas consultadas.
- Susan A. Ambrose et al. — *How Learning Works*. **Uso en esta clase:** diseñar los objetivos, la práctica y el feedback de **cierre y próximos pasos** sobre conocimiento previo verificable.
- Peter C. Brown, Henry L. Roediger III & Mark A. McDaniel — *Make It Stick*. **Uso en esta clase:** justificar la recuperación inicial y las preguntas de comprobación de **cierre y próximos pasos**.
- Grant Wiggins & Jay McTighe — *Understanding by Design*. **Uso en esta clase:** derivar el entregable de **cierre y próximos pasos** desde el desempeño observable y no desde el temario.
- Anders Ericsson & Robert Pool — *Peak*. **Uso en esta clase:** convertir la práctica de **cierre y próximos pasos** en práctica deliberada con criterios explícitos.
- William Ellet — *The Case Study Handbook*. **Uso en esta clase:** estructurar el caso ejecutivo de **cierre y próximos pasos** como problema, evidencia, alternativas y recomendación.
