# Evaluación — Clase 266: Sistemas antes que heroicidad
...
1. Distingue **business system** de **standard work** y crea un ejemplo donde confundirlos cambie la acción gerencial.
2. Explica **SOP** a partir de su definición operacional y señala una observación que la refutaría.
3. Relaciona **exception path** con **process owner**: ¿son causa, restricción, resultado o lentes distintos? Justifica.

## B. Caso de decisión — 30 %

**Caso:** Cada cierre mensual depende de una analista que conoce macros y passwords. Cuando renuncia, nadie puede emitir reportes por tres semanas.
...
Aplica **identificar procesos críticos → capturar standard y exceptions → asignar process owners → instrumentar métricas y controls → mejorar desde incidentes y feedback**. Debes utilizar o diseñar cómo obtener **process adherence, exception rate, cycle time**. Separa hechos, inferencias y supuestos; una métrica sin baseline o periodo no cuenta como evidencia suficiente.

## D. Fuentes, límites y red team — 15 %

Contrasta dos referencias de la clase. Resume con tus palabras qué lente aporta cada una, identifica una tensión y explica cómo modifica tu recomendación. Luego responde al límite: **No sistematices trabajo exploratorio prematuramente. Estandariza lo repetible y conserva autonomía donde el valor depende de judgment o innovación.**
