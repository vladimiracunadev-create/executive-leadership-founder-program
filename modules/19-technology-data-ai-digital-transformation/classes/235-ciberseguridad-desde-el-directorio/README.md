...
- Marco Iansiti & Karim R. Lakhani — *Competing in the Age of AI*. **Uso en esta clase:** modelo operativo AI-first, escala digital, redes y arquitectura de decisión. Lectura selectiva: índice/capítulos pertinentes a **ciberseguridad desde el directorio**; registra edición y páginas consultadas.
- Thomas H. Davenport & Nitin Mittal — *All-In on AI*. **Uso en esta clase:** casos empresariales, estrategia y organización para inteligencia artificial. Lectura selectiva: índice/capítulos pertinentes a **ciberseguridad desde el directorio**; registra edición y páginas consultadas.
- Thomas H. Davenport & Jeanne G. Harris — *Competing on Analytics*. **Uso en esta clase:** perspectiva de Datos aplicada al problema de la clase. Lectura selectiva: índice/capítulos pertinentes a **ciberseguridad desde el directorio**; registra edición y páginas consultadas.
