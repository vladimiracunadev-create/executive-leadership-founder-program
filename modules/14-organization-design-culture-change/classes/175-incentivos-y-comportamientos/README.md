# Clase 175 — Incentivos y comportamientos
...
Guarda en `portfolio/175-incentivos-y-comportamientos/`:

- `leadership-decision-brief.md` con el problema específico de **incentivos y comportamientos**, evidencia, alternativas, decisión y gobernanza;
- `reading-note.md` contrastando las fuentes de **incentivos y comportamientos** con edición/páginas consultadas;
- `decision-journal.md` registrando los supuestos de **incentive**, confianza, responsable y revisión;
- `red-team.md` con la objeción más fuerte al caso **Un call center paga por número de llamadas cerradas. Duración baja 20%, pero repeat calls y quejas suben; agentes transfieren casos complejos para proteger su ranking.** y el dato que podría invalidar la recomendación.

## 📗 Fuentes y verificación

- Jay R. Galbraith — *Designing Organizations* (Jossey-Bass Publishers, 1995). **Uso en esta clase:** alineación de estrategia, estructura, procesos, recompensas y personas. Lectura selectiva sobre **incentivos y comportamientos**. **Localizador:** [ISBN-13 9780787900915](https://openlibrary.org/isbn/9780787900915).
- Edgar H. Schein & Peter A. Schein — *Organizational Culture and Leadership* (John Wiley & Sons, Incorporated, 1991). **Uso en esta clase:** supuestos básicos, valores declarados y artefactos culturales. Lectura selectiva sobre **incentivos y comportamientos**. **Localizador:** [ISBN-13 9780470640562](https://openlibrary.org/isbn/9780470640562).
- Aaron Dignan — *Brave New Work* (Portfolio, 2019). **Uso en esta clase:** perspectiva de Diseño organizacional aplicada al problema de la clase. Lectura selectiva sobre **incentivos y comportamientos**. **Localizador:** [ISBN-13 9780525536208](https://openlibrary.org/isbn/9780525536208).
- John P. Kotter — *Accelerate* (Harvard Business Review Press, 2014). **Uso en esta clase:** perspectiva de Cambio aplicada al problema de la clase. Lectura selectiva sobre **incentivos y comportamientos**. **Localizador:** [ISBN-13 9781625271747](https://openlibrary.org/isbn/9781625271747).
- Chip Heath & Dan Heath — *Switch* (Penguin Random House, 1999). **Uso en esta clase:** dirección racional, motivación emocional y diseño del entorno para cambiar conducta. Lectura selectiva sobre **incentivos y comportamientos**. **Localizador:** [ISBN-13 9781847940308](https://openlibrary.org/isbn/9781847940308).
- John P. Kotter — *Leading Change* (Harvard Business School Press, 1996). **Uso en esta clase:** urgencia, coalición, visión, movilización y consolidación del cambio. Lectura selectiva sobre **incentivos y comportamientos**. **Localizador:** [ISBN-13 9780875847474](https://openlibrary.org/isbn/9780875847474).
- Susan A. Ambrose et al. — *How Learning Works* (John Wiley & Sons, Incorporated, 2010). **Uso en esta clase:** diseñar los objetivos, la práctica y el feedback de **incentivos y comportamientos** sobre conocimiento previo verificable. **Localizador:** [ISBN-13 9780470617601](https://openlibrary.org/isbn/9780470617601).
- Peter C. Brown, Henry L. Roediger III & Mark A. McDaniel — *Make It Stick* (Harvard University Press, 2014). **Uso en esta clase:** justificar la recuperación inicial y las preguntas de comprobación de **incentivos y comportamientos**. **Localizador:** [ISBN-13 9780674986572](https://openlibrary.org/isbn/9780674986572).
- Grant Wiggins & Jay McTighe — *Understanding by Design* (Pearson Education, Inc., 2006). **Uso en esta clase:** derivar el entregable de **incentivos y comportamientos** desde el desempeño observable y no desde el temario. **Localizador:** [ISBN-13 9780131950849](https://openlibrary.org/isbn/9780131950849).
- Anders Ericsson & Robert Pool — *Peak* (Penguin Random House, 2016). **Uso en esta clase:** convertir la práctica de **incentivos y comportamientos** en práctica deliberada con criterios explícitos. **Localizador:** [ISBN-13 9781473513143](https://openlibrary.org/isbn/9781473513143).
- William Ellet — *The Case Study Handbook* (Harvard Business Review Press, 2018). **Uso en esta clase:** estructurar el caso ejecutivo de **incentivos y comportamientos** como problema, evidencia, alternativas y recomendación. **Localizador:** [ISBN-13 9781633696150](https://openlibrary.org/isbn/9781633696150).
