# Clase 017 — Probabilidad, incertidumbre y riesgo
...
Guarda en `portfolio/017-probabilidad-incertidumbre-y-riesgo/`:

- `risk-governance-brief.md` con el problema específico de **probabilidad, incertidumbre y riesgo**, evidencia, alternativas, decisión y gobernanza;
- `reading-note.md` contrastando las fuentes de **probabilidad, incertidumbre y riesgo** con edición/páginas consultadas;
- `decision-journal.md` registrando los supuestos de **incertidumbre**, confianza, responsable y revisión;
- `red-team.md` con la objeción más fuerte al caso **Una empresa puede invertir 120 millones en capacidad adicional. La demanda futura puede crecer 30%, mantenerse o caer 15%; cada escenario cambia uso de caja y margen.** y el dato que podría invalidar la recomendación.

## 📗 Fuentes y verificación

- Daniel Kahneman — *Thinking, Fast and Slow*. **Uso en esta clase:** sesgos, juicio bajo incertidumbre y límites de la intuición. Lectura selectiva: índice/capítulos pertinentes a **probabilidad, incertidumbre y riesgo**; registra edición y páginas consultadas.
- Gary Klein — *Sources of Power*. **Uso en esta clase:** reconocimiento de patrones y decisión naturalista en contextos reales. Lectura selectiva: índice/capítulos pertinentes a **probabilidad, incertidumbre y riesgo**; registra edición y páginas consultadas.
- Donella H. Meadows — *Thinking in Systems*. **Uso en esta clase:** perspectiva de Sistemas aplicada al problema de la clase. Lectura selectiva: índice/capítulos pertinentes a **probabilidad, incertidumbre y riesgo**; registra edición y páginas consultadas.
- Annie Duke — *How to Decide*. **Uso en esta clase:** perspectiva de Decisiones aplicada al problema de la clase. Lectura selectiva: índice/capítulos pertinentes a **probabilidad, incertidumbre y riesgo**; registra edición y páginas consultadas.
- Max H. Bazerman & Don A. Moore — *Judgment in Managerial Decision Making*. **Uso en esta clase:** perspectiva de Decisiones aplicada al problema de la clase. Lectura selectiva: índice/capítulos pertinentes a **probabilidad, incertidumbre y riesgo**; registra edición y páginas consultadas.
- Annie Duke — *Thinking in Bets*. **Uso en esta clase:** calidad de la decisión separada del resultado y razonamiento probabilístico. Lectura selectiva: índice/capítulos pertinentes a **probabilidad, incertidumbre y riesgo**; registra edición y páginas consultadas.
- Susan A. Ambrose et al. — *How Learning Works*. **Uso en esta clase:** diseñar los objetivos, la práctica y el feedback de **probabilidad, incertidumbre y riesgo** sobre conocimiento previo verificable.
- Peter C. Brown, Henry L. Roediger III & Mark A. McDaniel — *Make It Stick*. **Uso en esta clase:** justificar la recuperación inicial y las preguntas de comprobación de **probabilidad, incertidumbre y riesgo**.
- Grant Wiggins & Jay McTighe — *Understanding by Design*. **Uso en esta clase:** derivar el entregable de **probabilidad, incertidumbre y riesgo** desde el desempeño observable y no desde el temario.
- Anders Ericsson & Robert Pool — *Peak*. **Uso en esta clase:** convertir la práctica de **probabilidad, incertidumbre y riesgo** en práctica deliberada con criterios explícitos.
- William Ellet — *The Case Study Handbook*. **Uso en esta clase:** estructurar el caso ejecutivo de **probabilidad, incertidumbre y riesgo** como problema, evidencia, alternativas y recomendación.
