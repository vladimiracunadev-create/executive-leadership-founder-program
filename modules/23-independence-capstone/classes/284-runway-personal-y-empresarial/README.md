# Clase 284 — Runway personal y empresarial
...
Guarda en `portfolio/284-runway-personal-y-empresarial/`:

- `risk-governance-brief.md` con el problema específico de **runway personal y empresarial**, evidencia, alternativas, decisión y gobernanza;
- `reading-note.md` contrastando las fuentes de **runway personal y empresarial** con edición/páginas consultadas;
- `decision-journal.md` registrando los supuestos de **personal runway**, confianza, responsable y revisión;
- `red-team.md` con la objeción más fuerte al caso **Founder cree tener 12 meses porque suma caja empresa y ahorros personales. Al separar IVA, impuestos, cuentas por pagar y gastos familiares, runway real es cinco meses.** y el dato que podría invalidar la recomendación.

## 📗 Fuentes y verificación

- Peter F. Drucker — *The Effective Executive*. **Uso en esta clase:** efectividad ejecutiva, contribución, prioridades y uso consciente del tiempo. Lectura selectiva: índice/capítulos pertinentes a **runway personal y empresarial**; registra edición y páginas consultadas.
- Peter F. Drucker — *Management: Tasks, Responsibilities, Practices*. **Uso en esta clase:** responsabilidad gerencial, propósito, organización y resultados. Lectura selectiva: índice/capítulos pertinentes a **runway personal y empresarial**; registra edición y páginas consultadas.
- Eric Ries — *The Lean Startup*. **Uso en esta clase:** build-measure-learn, MVP y aprendizaje validado. Lectura selectiva: índice/capítulos pertinentes a **runway personal y empresarial**; registra edición y páginas consultadas.
- Michael D. Watkins — *The First 90 Days*. **Uso en esta clase:** perspectiva de Transiciones aplicada al problema de la clase. Lectura selectiva: índice/capítulos pertinentes a **runway personal y empresarial**; registra edición y páginas consultadas.
- Michael E. Gerber — *The E-Myth Revisited*. **Uso en esta clase:** diferencia entre técnico, manager y empresario; sistematización del negocio. Lectura selectiva: índice/capítulos pertinentes a **runway personal y empresarial**; registra edición y páginas consultadas.
- Nassim Nicholas Taleb — *Antifragile*. **Uso en esta clase:** fragilidad, opcionalidad, redundancia y exposición asimétrica al riesgo. Lectura selectiva: índice/capítulos pertinentes a **runway personal y empresarial**; registra edición y páginas consultadas.
- Susan A. Ambrose et al. — *How Learning Works*. **Uso en esta clase:** diseñar los objetivos, la práctica y el feedback de **runway personal y empresarial** sobre conocimiento previo verificable.
- Peter C. Brown, Henry L. Roediger III & Mark A. McDaniel — *Make It Stick*. **Uso en esta clase:** justificar la recuperación inicial y las preguntas de comprobación de **runway personal y empresarial**.
- Grant Wiggins & Jay McTighe — *Understanding by Design*. **Uso en esta clase:** derivar el entregable de **runway personal y empresarial** desde el desempeño observable y no desde el temario.
- Anders Ericsson & Robert Pool — *Peak*. **Uso en esta clase:** convertir la práctica de **runway personal y empresarial** en práctica deliberada con criterios explícitos.
- William Ellet — *The Case Study Handbook*. **Uso en esta clase:** estructurar el caso ejecutivo de **runway personal y empresarial** como problema, evidencia, alternativas y recomendación.
