...
[![CI](https://github.com/vladimiracunadev-create/executive-leadership-founder-program/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/vladimiracunadev-create/executive-leadership-founder-program/actions/workflows/ci.yml)
...
[![Markdown](https://img.shields.io/badge/Markdown-contenido-000000?style=flat-square&logo=markdown&logoColor=white)](SYLLABUS.md)
[![GitHub Pages](https://img.shields.io/badge/GitHub%20Pages-portal%20vivo-222?style=flat-square&logo=githubpages&logoColor=white)](https://vladimiracunadev-create.github.io/executive-leadership-founder-program/)
...
```mermaid
flowchart LR
    A["Profesional"] --> B["Líder"]
    B --> C["Jefe / Team Lead"]
    C --> D["Manager"]
    D --> E["Gerente / Head"]
    E --> F["Director / Ejecutivo"]
    F --> G["CEO"]
    G --> H["Founder"]
    H --> I["Business Owner"]
```
...
```mermaid
flowchart LR
  subgraph E1["Etapa 1 · Partes 00-03"]
    A["Autoliderazgo"] --> B["Decisión"]
    B --> C["Comunicación"]
    C --> D["Resiliencia"]
  end
  subgraph E2["Etapa 2 · Partes 04-07"]
    F["Equipos"] --> G["Talento"]
    G --> H["Proyectos"]
    H --> I["Operaciones"]
  end
  subgraph E3["Etapa 3 · Partes 08-11"]
    J["KPI y OKR"] --> K["Finanzas"]
    K --> L["Ventas"]
    L --> M["Marketing"]
  end
  subgraph E4["Etapa 4 · Partes 12-15"]
    N["Producto"] --> O["Estrategia"]
    O --> P["Organización"]
    P --> Q["Riesgo y gobierno"]
  end
  subgraph E5["Etapa 5 · Partes 16-19"]
    R["Oficina del CEO"] --> S["Directorio"]
    S --> T["Capital y M&A"]
    T --> U["Tecnología e IA"]
  end
  subgraph E6["Etapa 6 · Partes 20-23"]
    V["Founder"] --> W["Chile: formalizar"]
    W --> X["Escalar"]
    X --> Y["Independencia"]
  end
  E1 --> E2 --> E3 --> E4 --> E5 --> E6
...
[![GitHub stars](https://img.shields.io/github/stars/vladimiracunadev-create/executive-leadership-founder-program?style=social)](https://github.com/vladimiracunadev-create/executive-leadership-founder-program/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/vladimiracunadev-create/executive-leadership-founder-program?style=social)](https://github.com/vladimiracunadev-create/executive-leadership-founder-program/network/members)
