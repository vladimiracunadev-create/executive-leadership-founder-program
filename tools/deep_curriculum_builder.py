...
def official_extra(part,title,cid):
    ...
    if part==9:
        if any(x in low for x in ('estado','balance','flujo','margen','capital de trabajo')):
            extra.append('- IFRS Foundation — normas IFRS/IAS aplicables a presentación y lectura de estados financieros. Verificar edición vigente en <https://www.ifrs.org/>.')
    if part==15:
        if 'ciber' in low: extra.append('- NIST — *Cybersecurity Framework 2.0*. Fuente primaria: <https://www.nist.gov/cyberframework>.')
        if 'ia' in low: extra.append('- NIST — *AI Risk Management Framework*. Fuente primaria: <https://www.nist.gov/itl/ai-risk-management-framework>.')
        if 'riesgo' in low or 'controles' in low: extra.append('- COSO — *Enterprise Risk Management* / *Internal Control*. Fuente institucional: <https://www.coso.org/>.')
    if part==17:
        extra.append('- OECD — *G20/OECD Principles of Corporate Governance 2023*. Fuente primaria: <https://www.oecd.org/corporate/principles-corporate-governance/>.')
    if part==19:
        if 'ciber' in low: extra.append('- NIST — *Cybersecurity Framework 2.0*. <https://www.nist.gov/cyberframework>.')
        if 'ia' in low: extra.append('- NIST — *AI Risk Management Framework*. <https://www.nist.gov/itl/ai-risk-management-framework>.')
    if part==21:
        # Las clases chilenas reciben fuentes oficiales específicas más abajo.
        mapping={
        253:['- SII Educa — formalización de negocios: <https://www.sii.cl/siieduca/aprende-con-nosotros/inicio-de-actividades-y-formalizacion-de-un-negocio.html>.','- Registro de Empresas y Sociedades — portal oficial: <https://www.registrodeempresasysociedades.cl/>.'],
        254:['- Registro de Empresas y Sociedades — información oficial sobre formas societarias: <https://www.registrodeempresasysociedades.cl/FAQ.aspx>.','- SII — Portal Emprendedor: <https://www.sii.cl/portales/emprendedor/>.'],
        255:['- Registro de Empresas y Sociedades — FAQ y tipos de empresas: <https://www.registrodeempresasysociedades.cl/FAQ.aspx>.','- Ley N.º 20.659 y normativa vinculada, consultar texto vigente en BCN LeyChile: <https://www.bcn.cl/leychile/>.'],
        256:['- SII — Ciclo de vida del contribuyente, Inicio de Actividades: <https://www.sii.cl/destacados/educacion/ciclo_vida_contribuyente/paso_02.html>.','- SII — ayudas para Inicio de Actividades: <https://www.sii.cl/pagina/registro_contribuyentes/ayudas_inicio_actividades.htm>.'],
        257:['- SII — normativa, documentos tributarios electrónicos e IVA: <https://www.sii.cl/>.','- Código Tributario y Ley sobre Impuesto a las Ventas y Servicios, textos vigentes en BCN LeyChile: <https://www.bcn.cl/leychile/>.'],
        258:['- SII — declaraciones, registros y calendario tributario: <https://www.sii.cl/>.','- Colegio de Contadores / normativa contable aplicable y NIIF cuando corresponda; verificar alcance según entidad.'],
        259:['- CMF — información y normativa del sistema financiero: <https://www.cmfchile.cl/>.','- SII — acreditación de Inicio de Actividades y obligaciones tributarias: <https://www.sii.cl/destacados/ley_cumplimiento_obligaciones_tributarias/inicio_actividades.html>.'],
        260:['- Dirección del Trabajo — Contrato Individual de Trabajo: <https://dt.gob.cl/portal/1626/w3-article-100172.html>.','- Dirección del Trabajo — cláusulas mínimas del contrato: <https://www.dt.gob.cl/portal/1628/w3-article-60800.html>.','- Dirección del Trabajo — implementación de la rebaja a 42 horas desde 26-04-2026 (Ord. N°253/21): <https://dt.gob.cl/legislacion/1624/w3-article-129189.html>.','- Dirección del Trabajo — Ley Karin y dictámenes asociados: <https://www.dt.gob.cl/legislacion/1624/w3-propertyvalue-194488.html>.','- Código del Trabajo, texto vigente en BCN LeyChile: <https://www.bcn.cl/leychile/navegar?idNorma=207436>.','- Subsecretaría de Previsión Social — Decreto Supremo N°44 y material de implementación: <https://previsionsocial.gob.cl/ds44/>.','- SUSESO — normativa de seguridad y salud laboral y Ley N°16.744: <https://www.suseso.cl/>.'],
        261:['- INAPI — portal oficial de propiedad industrial: <https://www.inapi.cl/>.','- Departamento de Derechos Intelectuales / Servicio Nacional del Patrimonio Cultural — derecho de autor: <https://www.propiedadintelectual.gob.cl/>.'],
        262:['- ChileAtiende y municipalidad competente — permisos y patente según giro; verificar autoridad específica.','- SII Educa — formalización y permisos: <https://www.sii.cl/siieduca/aprende-con-nosotros/inicio-de-actividades-y-formalizacion-de-un-negocio.html>.'],
        263:['- ChileCompra / Mercado Público — portal oficial: <https://www.chilecompra.cl/>.','- Sercotec — portal oficial: <https://www.sercotec.cl/>.','- Corfo — portal oficial: <https://www.corfo.cl/>.'],
        264:['- SII — Portal Emprendedor: <https://www.sii.cl/portales/emprendedor/>.','- Registro de Empresas y Sociedades: <https://www.registrodeempresasysociedades.cl/>.','- Dirección del Trabajo: <https://www.dt.gob.cl/>.','- INAPI: <https://www.inapi.cl/>.'],
        }
