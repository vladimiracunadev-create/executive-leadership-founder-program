# Evaluación — Clase 279: Consultoría y servicios profesionales
...
1. Distingue **consulting engagement** de **scope** y crea un ejemplo donde confundirlos cambie la acción gerencial.
2. Explica **deliverable** a partir de su definición operacional y señala una observación que la refutaría.
3. Relaciona **retainer** con **value pricing**: ¿son causa, restricción, resultado o lentes distintos? Justifica.

## B. Caso de decisión — 30 %

**Caso:** Cliente pide ayuda con tecnología por tres meses. Sin scope, el consultor termina respondiendo tickets y no puede demostrar outcome.
...
Aplica **elegir problema e ICP → hacer discovery y diagnose → definir scope y outcome → proponer fee y terms → entregar medir y request reference**. Debes utilizar o diseñar cómo obtener **utilization, effective rate, proposal win rate**. Separa hechos, inferencias y supuestos; una métrica sin baseline o periodo no cuenta como evidencia suficiente.

## D. Fuentes, límites y red team — 15 %

Contrasta dos referencias de la clase. Resume con tus palabras qué lente aporta cada una, identifica una tensión y explica cómo modifica tu recomendación. Luego responde al límite: **Value pricing no significa cobrar cifras arbitrarias ni ocultar esfuerzo. Debe ser transparente, defendible y compatible con mercado, ética y contrato.**
