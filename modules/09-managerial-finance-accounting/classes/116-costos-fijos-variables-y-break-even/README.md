...
- Charles Horngren et al. — *Cost Accounting: A Managerial Emphasis*. **Uso en esta clase:** costos relevantes, presupuestos, variaciones y decisiones gerenciales. Lectura selectiva: índice/capítulos pertinentes a **costos fijos, variables y break-even**; registra edición y páginas consultadas.
- Richard Brealey, Stewart Myers & Franklin Allen — *Principles of Corporate Finance*. **Uso en esta clase:** valor del dinero, riesgo, costo de capital, inversión y financiación. Lectura selectiva: índice/capítulos pertinentes a **costos fijos, variables y break-even**; registra edición y páginas consultadas.
- Stephen Ross, Randolph Westerfield et al. — *Corporate Finance*. **Uso en esta clase:** decisiones de inversión, financiación, capital de trabajo y valoración. Lectura selectiva: índice/capítulos pertinentes a **costos fijos, variables y break-even**; registra edición y páginas consultadas.
