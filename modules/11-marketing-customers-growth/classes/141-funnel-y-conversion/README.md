...
- Philip Kotler & Kevin Lane Keller — *Marketing Management*. **Uso en esta clase:** segmentación, targeting, posicionamiento, propuesta de valor y marketing mix. Lectura selectiva: índice/capítulos pertinentes a **funnel y conversión**; registra edición y páginas consultadas.
- Byron Sharp — *How Brands Grow*. **Uso en esta clase:** disponibilidad mental y física, penetración y patrones empíricos de crecimiento de marcas. Lectura selectiva: índice/capítulos pertinentes a **funnel y conversión**; registra edición y páginas consultadas.
- April Dunford — *Obviously Awesome*. **Uso en esta clase:** posicionamiento desde alternativas competitivas, atributos, valor y segmento. Lectura selectiva: índice/capítulos pertinentes a **funnel y conversión**; registra edición y páginas consultadas.
- Al Ries & Jack Trout — *Positioning*. **Uso en esta clase:** perspectiva de Marketing aplicada al problema de la clase. Lectura selectiva: índice/capítulos pertinentes a **funnel y conversión**; registra edición y páginas consultadas.
- Gabriel Weinberg & Justin Mares — *Traction*. **Uso en esta clase:** perspectiva de Growth aplicada al problema de la clase. Lectura selectiva: índice/capítulos pertinentes a **funnel y conversión**; registra edición y páginas consultadas.
- Alexander Osterwalder & Yves Pigneur — *Business Model Generation*. **Uso en esta clase:** diseño de modelos de negocio mediante propuesta, clientes, recursos y economía. Lectura selectiva: índice/capítulos pertinentes a **funnel y conversión**; registra edición y páginas consultadas.
