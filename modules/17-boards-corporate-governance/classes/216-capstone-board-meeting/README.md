...
- `board-or-executive-memo.md` con el problema específico de **capstone: board meeting**, evidencia, alternativas, decisión y gobernanza;
- `reading-note.md` contrastando las fuentes de **capstone: board meeting** con edición/páginas consultadas;
- `decision-journal.md` registrando los supuestos de **board agenda**, confianza, responsable y revisión;
- `red-team.md` con la objeción más fuerte al caso **La reunión debe decidir adquisición, aprobar presupuesto anual y revisar incidente de datos mientras EBITDA va bajo plan y el CEO propone cambiar estructura comercial.** y el dato que podría invalidar la recomendación.

## 📗 Fuentes y verificación

- Bob Tricker — *Corporate Governance*. **Uso en esta clase:** separación entre dirección, supervisión, accountability y gobierno corporativo. Lectura selectiva: índice/capítulos pertinentes a **capstone: board meeting**; registra edición y páginas consultadas.
...
- Michael E. Porter & Mark R. Kramer — *Creating Shared Value*. **Uso en esta clase:** perspectiva de Estrategia / Impacto aplicada al problema de la clase. Lectura selectiva: índice/capítulos pertinentes a **capstone: board meeting**; registra edición y páginas consultadas.
- Richard Leblanc & James Gillies — *Inside the Boardroom*. **Uso en esta clase:** comportamiento efectivo del directorio, composición y dinámica de gobierno. Lectura selectiva: índice/capítulos pertinentes a **capstone: board meeting**; registra edición y páginas consultadas.
- Robert A. G. Monks & Nell Minow — *Corporate Governance*. **Uso en esta clase:** perspectiva de Gobierno corporativo aplicada al problema de la clase. Lectura selectiva: índice/capítulos pertinentes a **capstone: board meeting**; registra edición y páginas consultadas.
- Ram Charan — *Boards That Deliver*. **Uso en esta clase:** directorios que contribuyen a estrategia, talento, riesgo y sucesión. Lectura selectiva: índice/capítulos pertinentes a **capstone: board meeting**; registra edición y páginas consultadas.
- Susan A. Ambrose et al. — *How Learning Works*. **Uso en esta clase:** diseñar los objetivos, la práctica y el feedback de **capstone: board meeting** sobre conocimiento previo verificable.
- Peter C. Brown, Henry L. Roediger III & Mark A. McDaniel — *Make It Stick*. **Uso en esta clase:** justificar la recuperación inicial y las preguntas de comprobación de **capstone: board meeting**.
- Grant Wiggins & Jay McTighe — *Understanding by Design*. **Uso en esta clase:** derivar el entregable de **capstone: board meeting** desde el desempeño observable y no desde el temario.
- Anders Ericsson & Robert Pool — *Peak*. **Uso en esta clase:** convertir la práctica de **capstone: board meeting** en práctica deliberada con criterios explícitos.
- William Ellet — *The Case Study Handbook*. **Uso en esta clase:** estructurar el caso ejecutivo de **capstone: board meeting** como problema, evidencia, alternativas y recomendación.
