# Evaluación — Clase 271: Multiunidad y portafolio
...
1. Distingue **business unit** de **portfolio** y crea un ejemplo donde confundirlos cambie la acción gerencial.
2. Explica **shared service** a partir de su definición operacional y señala una observación que la refutaría.
3. Relaciona **portfolio parenting** con **capital allocation**: ¿son causa, restricción, resultado o lentes distintos? Justifica.

## B. Caso de decisión — 30 %

**Caso:** Owner tiene consultoría rentable, SaaS creciente y e-commerce deficitario. Contabilidad mezcla gastos y el SaaS parece rentable porque consultoría paga equipo compartido.
...
Aplica **definir unidad económica → separar P&L y cash → identificar shared capabilities → medir parenting advantage → allocate grow harvest o exit**. Debes utilizar o diseñar cómo obtener **ROIC by unit, cash generation, shared-service cost**. Separa hechos, inferencias y supuestos; una métrica sin baseline o periodo no cuenta como evidencia suficiente.

## D. Fuentes, límites y red team — 15 %

Contrasta dos referencias de la clase. Resume con tus palabras qué lente aporta cada una, identifica una tensión y explica cómo modifica tu recomendación. Luego responde al límite: **Separar demasiado puede perder sinergias y crear duplicación. Diseña transfer pricing o allocation transparente para ver economics sin destruir colaboración.**
