...
|---|---:|---:|---:|---|
| 🟢 1 · Autoliderazgo y fundamentos ejecutivos | 4 | 48 | 120 | Profesional → Líder |
| 🔵 2 · Liderazgo de equipos y ejecución | 4 | 48 | 120 | Líder → Jefe / Team Lead |
| 🟣 3 · Gestión de negocio | 4 | 48 | 120 | Manager → Gerente |
| 🟠 4 · Dirección, estrategia y organización | 4 | 48 | 120 | Gerente → Director / Head |
| 🔴 5 · Alta dirección y gobierno | 4 | 48 | 120 | Ejecutivo → CEO |
| ⚫ 6 · Fundador, propietario e independencia | 4 | 48 | 120 | Founder → Business Owner |
...
|---|---|
| `tools/validate_repository.py --strict` | Las 24 partes, sus 288 clases y sus tres archivos existen, con las 16 secciones del contrato y títulos coherentes entre `lesson.yaml`, clase y evaluación. |
